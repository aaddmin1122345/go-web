!function(t, e) {
    ...
    k = function() {
        ...
        return t.toggle = function() {
            ...
            t && m(this._element).toggleClass(b)
        }
        ,
        t.dispose = function() {
    ...
    m(document).on(O.CLICK_DATA_API, I, function(t) {
        t.preventDefault();
        var e = t.target;
        m(e).hasClass(T) || (e = m(e).closest(N)),
    ...
    $t = function() {
        ...
        var t = c.prototype;
        return t.toggle = function() {
            if (!this._element.disabled && !Tt(this._element).hasClass(kt)) {
                var t = c._getParentFromElement(this._element)
                  , e = Tt(this._menu).hasClass(Pt);
                if (c._clearMenus(),
                !e) {
                    var n = {
                        relatedTarget: this._element
                    }
                      , i = Tt.Event(Ot.SHOW, n);
                    if (Tt(t).trigger(i),
                    !i.isDefaultPrevented()) {
                        if (!this._inNavbar) {
                            if (void 0 === h)
                            ...
                            "scrollParent" !== this._config.boundary && Tt(t).addClass(xt),
                            this._popper = new h(r,this._menu,this._getPopperConfig())
                        }
                        "ontouchstart"in document.documentElement && 0 === Tt(t).closest(Ft).length && Tt(document.body).children().on("mouseover", null, Tt.noop),
                        this._element.focus(),
                        this._element.setAttribute("aria-expanded", !0),
                        Tt(this._menu).toggleClass(Pt),
                        Tt(t).toggleClass(Pt).trigger(Tt.Event(Ot.SHOWN, n))
                    }
                }
            }
        }
        ...
        t._addEventListeners = function() {
            var e = this;
            Tt(this._element).on(Ot.CLICK, function(t) {
                t.preventDefault(),
                t.stopPropagation(),
                e.toggle()
            })
        ...
        ,
        t._getConfig = function(t) {
            return t = l({}, this.constructor.Default, Tt(this._element).data(), t),
        ...
        t._getPlacement = function() {
            ...
            Tt(this._menu).hasClass(Rt) && (e = Qt)) : t.hasClass(Lt) ? e = Yt : t.hasClass(Ht) ? e = zt : Tt(this._menu).hasClass(Rt) && (e = Vt),
            e
        }
        ,
        ...
        c._clearMenus = function(t) {
            if (!t || 3 !== t.which && ("keyup" !== t.type || 9 === t.which))
                for (var e = [].slice.call(document.querySelectorAll(Wt)), n = 0, i = e.length; n < i; n++) {
                    ...
                    o) {
                        var a = o._menu;
                        if (Tt(r).hasClass(Pt) && !(t && ("click" === t.type && /input|textarea/i.test(t.target.tagName) || "keyup" === t.type && 9 === t.which) && Tt.contains(r, t.target))) {
                            var l = Tt.Event(Ot.HIDE, s);
                            Tt(r).trigger(l),
                            ...
                            Tt(a).removeClass(Pt),
                            Tt(r).removeClass(Pt).trigger(Tt.Event(Ot.HIDDEN, s)))
                        }
                    }
                }
        }
        ...
        c._dataApiKeydownHandler = function(t) {
            if ((/input|textarea/i.test(t.target.tagName) ? !(32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || Tt(t.target).closest(qt).length)) : Nt.test(t.which)) && (t.preventDefault(),
            t.stopPropagation(),
            !this.disabled && !Tt(this).hasClass(kt))) {
    ...
    Tt(document).on(Ot.KEYDOWN_DATA_API, Wt, $t._dataApiKeydownHandler).on(Ot.KEYDOWN_DATA_API, qt, $t._dataApiKeydownHandler).on(Ot.CLICK_DATA_API + " " + Ot.KEYUP_DATA_API, $t._clearMenus).on(Ot.CLICK_DATA_API, Wt, function(t) {
        t.preventDefault(),
        t.stopPropagation(),
        $t._jQueryInterface.call(Tt(this), "toggle")
    }).on(Ot.CLICK_DATA_API, Ut, function(t) {
        t.stopPropagation()
    }),
    Tt.fn[St] = $t._jQueryInterface,
    Tt.fn[St].Constructor = $t,
    ...
    me = function() {
        ...
        t.show = function(t) {
            ...
            if (!this._isTransitioning && !this._isShown) {
                ...
                Gt(this._element).on(oe.CLICK_DISMISS, de, function(t) {
                    return e.hide(t)
                }),
        ...
        t._showElement = function(t) {
            var e = this
              , n = Gt(this._element).hasClass(ce);
            this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element),
            this._element.style.display = "block",
            this._element.removeAttribute("aria-hidden"),
            this._element.scrollTop = 0,
            n && Fn.reflow(this._element),
            Gt(this._element).addClass(he),
            this._config.focus && this._enforceFocus();
            var i = Gt.Event(oe.SHOWN, {
                relatedTarget: t
            })
              , r = function() {
            ...
            if (n) {
                ...
                Gt(this._dialog).one(Fn.TRANSITION_END, r).emulateTransitionEnd(o)
            } else
                r()
        }
        ,
        ...
        t._showBackdrop = function(t) {
            var e = this
              , n = Gt(this._element).hasClass(ce) ? ce : "";
            if (this._isShown && this._config.backdrop) {
                ...
                Gt(this._backdrop).addClass(he),
                !t)
                    return;
                if (!n)
                    return void t();
                var i = Fn.getTransitionDurationFromElement(this._backdrop);
                Gt(this._backdrop).one(Fn.TRANSITION_END, t).emulateTransitionEnd(i)
                ...
                if (Gt(this._element).hasClass(ce)) {
                    ...
                    Gt(this._backdrop).one(Fn.TRANSITION_END, r).emulateTransitionEnd(o)
                } else
                    r()
            } else
                t && t()
            ...
            if (this._isBodyOverflowing) {
                ...
                Gt(t).each(function(t, e) {
                    var n = e.style.paddingRight
                      , i = Gt(e).css("padding-right");
                    Gt(e).data("padding-right", n).css("padding-right", parseFloat(i) + r._scrollbarWidth + "px")
                }),
                Gt(e).each(function(t, e) {
                    var n = e.style.marginRight
                      , i = Gt(e).css("margin-right");
                    Gt(e).data("margin-right", n).css("margin-right", parseFloat(i) - r._scrollbarWidth + "px")
                });
                var n = document.body.style.paddingRight
                  , i = Gt(document.body).css("padding-right");
                Gt(document.body).data("padding-right", n).css("padding-right", parseFloat(i) + this._scrollbarWidth + "px")
            }
        }
        ,
        ...
        r._jQueryInterface = function(n, i) {
            return this.each(function() {
                var t = Gt(this).data(te)
                  , e = l({}, ie, Gt(this).data(), "object" == typeof n && n ? n : {});
                if (t || (t = new r(this,e),
                Gt(this).data(te, t)),
                "string" == typeof n) {
                    if (void 0 === t[n])
    ...
    Gt(document).on(oe.CLICK_DATA_API, fe, function(t) {
        var e, n = this, i = Fn.getSelectorFromElement(this);
        i && (e = document.querySelector(i));
        var r = Gt(e).data(te) ? "toggle" : l({}, Gt(e).data(), Gt(this).data());
        ...
        me._jQueryInterface.call(Gt(e), r, this)
    }),
    Gt.fn[Xt] = me._jQueryInterface,
    Gt.fn[Xt].Constructor = me,
    Gt.fn[Xt].noConflict = function() {
        return Gt.fn[Xt] = ne,
        me._jQueryInterface
    }
    ,
    ...
    We = function() {
        ...
        t.hide = function(t) {
            var e = this
              ...
              , r = function() {
                e._hoverState !== we && n.parentNode && n.parentNode.removeChild(n),
                e._cleanTipClass(),
        ...
        t.addAttachmentClass = function(t) {
            pe(this.getTipElement()).addClass(be + "-" + t)
        }
        ,
        ...
        t._enter = function(t, e) {
            ...
            t && (e._activeTrigger["focusin" === t.type ? He : Le] = !0),
            pe(e.getTipElement()).hasClass(ke) || e._hoverState === we ? e._hoverState = we : (clearTimeout(e._timeout),
            e._hoverState = we,
        ...
        t._leave = function(t, e) {
            ...
            (e = e || pe(t.currentTarget).data(n)) || (e = new this.constructor(t.currentTarget,this._getDelegateConfig()),
            pe(t.currentTarget).data(n, e)),
            t && (e._activeTrigger["focusout" === t.type ? He : Le] = !1),
    ...
    Xe = function(t) {
        ...
        r.setContent = function() {
            ...
            this.setElementContent(t.find($e), e),
            t.removeClass(ze + " " + Je)
        }
        ,
    ...
    tn.fn[en] = bn._jQueryInterface,
    tn.fn[en].Constructor = bn,
    ...
    qn = function() {
        ...
        return t.show = function() {
            var n = this;
            if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && Tn(this._element).hasClass(Nn) || Tn(this._element).hasClass(On))) {
                var t, i, e = Tn(this._element).closest(Ln)[0], r = Fn.getSelectorFromElement(this._element);
                if (e) {
                    var o = "UL" === e.nodeName ? Rn : Hn;
                    i = (i = Tn.makeArray(Tn(e).find(o)))[i.length - 1]
                }
                var s = Tn.Event(wn.HIDE, {
                    relatedTarget: this._element
                })
                  , a = Tn.Event(wn.SHOW, {
                    relatedTarget: i
                ...
                if (i && Tn(i).trigger(s),
                Tn(this._element).trigger(a),
                !a.isDefaultPrevented() && !s.isDefaultPrevented()) {
                    r && (t = document.querySelector(r)),
                    this._activate(this._element, e);
                    var l = function() {
                        var t = Tn.Event(wn.HIDDEN, {
        ...
        ,
        t.dispose = function() {
            Tn.removeData(this._element, Sn),
            this._element = null
        }
        ,
        t._activate = function(t, e, n) {
            var i = this
              , r = ("UL" === e.nodeName ? Tn(e).find(Rn) : Tn(e).children(Hn))[0]
              , o = n && r && Tn(r).hasClass(kn)
              , s = function() {
                return i._transitionComplete(t, r, n)
            };
            if (r && o) {
                var a = Fn.getTransitionDurationFromElement(r);
                Tn(r).one(Fn.TRANSITION_END, s).emulateTransitionEnd(a)
            } else
                s()
        }
        ,
        t._transitionComplete = function(t, e, n) {
            if (e) {
                Tn(e).removeClass(Pn + " " + Nn);
                var i = Tn(e.parentNode).find(Un)[0];
                i && Tn(i).removeClass(Nn),
            ...
            Fn.reflow(t),
            Tn(t).addClass(Pn),
            t.parentNode && Tn(t.parentNode).hasClass(Dn)) {
                var r = Tn(t).closest(jn)[0];
                if (r) {
    ...
    Tn(document).on(wn.CLICK_DATA_API, xn, function(t) {
        t.preventDefault(),
        qn._jQueryInterface.call(Tn(this), "show")
    }),
    Tn.fn.tab = qn._jQueryInterface,
    Tn.fn.tab.Constructor = qn,
    Tn.fn.tab.noConflict = function() {
        return Tn.fn.tab = An,
        qn._jQueryInterface
    }
    ,
